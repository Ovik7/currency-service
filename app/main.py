...
from app.api.currencies import currencies
...
app = FastAPI(openapi_url="/api/v1/currencies/openapi.json", docs_url="/api/v1/currencies/docs")
...
app.include_router(currencies, prefix='/api/v1/currencies', tags=['currencies'])